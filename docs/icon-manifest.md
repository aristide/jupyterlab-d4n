...
| Names now overridden and verified applied          | **58** (45%)                               |
| Deferred by decision (language marks, I6)          | 3                                          |
| Excluded — Jupyter marks nothing draws             | 2                                          |
...
| **all surfaces (with repeats)** | **79** | **2**    | **19**          | **100** |                                                                    |
...
| 70  | `ui-components:jupyter`               | OVERRIDDEN            | `svg/brand/logo-mark.svg` _(D-021, P0-12)_ | Top panel                                                                           |
| 71  | `ui-components:jupyter-favicon`       | EXCLUDED — favicon    | — _(server-side, PRD §8.9.2 / P1-08)_      | —                                                                                   |
| 72  | `ui-components:jupyterlab-wordmark`   | EXCLUDED — unrendered | — _(no surface renders it; D-021)_         | —                                                                                   |
